...
describe "#multiply" do
  ...
  it "multiplies two other numbers" do
    ...
    expect(multiply(12, 12)).to eq(144) # Added by Julien
  end

  it "multiplies two other numbers, one of them being 0" do
    # one last test, with 0 in it
    expect(multiply(18238232, 0)).to eq(0) # Added by Julien
  end 
...
describe "#factorial" do
  it "computes the factorial of 0" do 
    expect(factorial(0)).to eq(0) # Added by Julien
  end

  it "computes the factorial of 1" do 
    expect(factorial(1)).to eq(1) # Added by Julien
  end

  it "computes the factorial of 2" do 
    expect(factorial(2)).to eq(2) # Added by Julien
  end

  it "computes the factorial of 5" do 
    expect(factorial(5)).to eq(120) # Added by Julien
  end

  it "computes the factorial of 10" do 
    expect(factorial(10)).to eq(3628800) # Added by Julien
  end
